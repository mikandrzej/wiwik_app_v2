...
int DataContainer::getVehiclesCount()
{
    return m_vehiclesList.count();
}

int DataContainer::getDevicesCount()
{
    return m_devicesList.count();
}

int DataContainer::getSensorsCount()
{
    return m_sensorsList.count();
}

QList<Vehicle*> DataContainer::getVehicleList()
{
    return m_vehiclesList;
}

QList<Device*> DataContainer::getDeviceList()
{
...
void DataContainer::addDevice(Device* device)
{
    ...
    connect(newDevice, &Device::changesPendingChanged, this, [this, newDevice]() { emit deviceDataChanged(m_devicesList.indexOf(newDevice)); });
    connect(newDevice, &Device::nameChanged, this, [this, newDevice]() { emit deviceDataChanged(m_devicesList.indexOf(newDevice)); });
...
void DataContainer::addVehicle(Vehicle* vehicle)
{
    ...
    connect(newVehicle, &Vehicle::changesPendingChanged, this, [this, newVehicle]() { emit vehicleDataChanged(m_vehiclesList.indexOf(newVehicle)); });
    connect(newVehicle, &Vehicle::nameChanged, this, [this, newVehicle]() { emit vehicleDataChanged(m_vehiclesList.indexOf(newVehicle)); });
    connect(newVehicle, &Vehicle::plateNoChanged, this, [this, newVehicle]() { emit vehicleDataChanged(m_vehiclesList.indexOf(newVehicle)); });
...
void DataContainer::addSensor(Sensor* sensor)
{
    ...
    connect(newSensor, &Sensor::changesPendingChanged, this, [this, newSensor]() { emit sensorDataChanged(m_sensorsList.indexOf(newSensor)); });
    connect(newSensor, &Sensor::nameChanged, this, [this, newSensor]() { emit sensorDataChanged(m_sensorsList.indexOf(newSensor)); });
    ...
    connect(newSensor, &Sensor::lastMeasureChanged, this, [this, newSensor]() { emit sensorDataChanged(m_sensorsList.indexOf(newSensor)); });
