...
DialogAssignSensor::DialogAssignSensor(QWidget* parent) : QDialog(parent), ui(new Ui::DialogAssignSensor)
{
    ui->setupUi(this);
}

DialogAssignSensor::~DialogAssignSensor()
{
    delete ui;
}

void DialogAssignSensor::setVehiclesList(const EgVehiclesData& vehicleListData)
{
...
void DialogAssignSensor::setDevicesList(const EgDevicesListData& deviceListData)
{
