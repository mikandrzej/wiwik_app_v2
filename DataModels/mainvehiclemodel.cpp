...
MainVehicleModel::MainVehicleModel(QObject *parent)
...
int MainVehicleModel::columnCount(const QModelIndex &parent) const {
  if (parent.isValid()) {
    VehModelTreeItem *item =
        static_cast<VehModelTreeItem *>(parent.internalPointer());
...
QVariant MainVehicleModel::data(const QModelIndex &index, int role) const {
  ...
  VehModelTreeItem *item =
      static_cast<VehModelTreeItem *>(index.internalPointer());
...
void MainVehicleModel::onNewVehicleData(
    const MainVehicleModelData &vehicleData) {
...
MainVehicleModelData::MainVehicleModelData(
    const MainVehicleModelData *sourceObject, QObject *parent)
    : QObject(parent) {
...
int MainVehicleModelData::id() const { return m_id; }
...
QString MainVehicleModelData::name() const { return m_name; }
...
QString MainVehicleModelData::plateNo() const { return m_plateNo; }
...
bool MainVehicleModelData::active() const { return m_active; }
...
QVariant MainVehicleModel::headerData(int section, Qt::Orientation orientation,
                                      int role) const {
...
int MainDeviceModelData::id() const { return m_id; }
...
QString MainDeviceModelData::serialNo() const { return m_serialNo; }
...
QString MainDeviceModelData::name() const { return m_name; }
...
bool MainDeviceModelData::active() const { return m_active; }
...
int MainDeviceModelData::vehicleId() const { return m_vehicleId; }
...
int MainDeviceModelData::typeId() const { return m_typeId; }
