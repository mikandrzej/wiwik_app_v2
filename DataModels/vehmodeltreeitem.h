...
class MainVehicleModelData : public QObject
{
    Q_OBJECT
  public:
    MainVehicleModelData(const MainVehicleModelData* sourceObject = nullptr, QObject* parent = nullptr);
...
class MainDeviceModelData : public QObject
{
    Q_OBJECT
  public:
    MainDeviceModelData(const MainDeviceModelData* sourceObject = nullptr, QObject* parent = nullptr);
...
{
  public:
    explicit VehModelTreeItem(const MainModelData& data, VehModelTreeItem* parentItem = nullptr);
    ~VehModelTreeItem();
