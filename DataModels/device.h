...
class Device : public QObject
{
    Q_OBJECT
  public:
    explicit Device(int id, QString& serialNo, QString& name, int vehicleId, QString& type, QObject* parent = nullptr);
  ...
  private:
    ...
    Q_PROPERTY(bool changesPending READ changesPending WRITE setChangesPending NOTIFY changesPendingChanged)
