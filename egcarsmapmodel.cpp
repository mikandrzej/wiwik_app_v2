...
QVariantList EgCarMapModel::polylinePath() const { return m_polylinePath; }
...
QColor EgCarMapModel::polylineColor() const { return m_polylineColor; }
...
int EgCarMapModel::polylineWidth() const { return m_polylineWidth; }
...
double EgCarMapModel::circleRadius() const { return m_circleRadius; }
...
QColor EgCarMapModel::color() const { return m_color; }
...
int EgCarMapModel::circleBorderWidth() const { return m_circleBorderWidth; }
