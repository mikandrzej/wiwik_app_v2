...
VehicleTableModel::VehicleTableModel(QObject *parent)
    : QAbstractTableModel{parent} {

  connect(DataContainer::instance(), &DataContainer::vehicleDataToBeInserted,
          this, [this](int row) { beginInsertRows(QModelIndex(), row, row); });
  connect(DataContainer::instance(), &DataContainer::vehicleDataInsertDone,
          this, [this]() { endInsertRows(); });
  connect(DataContainer::instance(), &DataContainer::vehicleDataChanged, this,
          [this](int idx) {
            emit dataChanged(
...
bool VehicleTableModel::setData(const QModelIndex &index, const QVariant &value,
                                int role) {
...
QVariant VehicleTableModel::headerData(int section, Qt::Orientation orientation,
                                       int role) const {
