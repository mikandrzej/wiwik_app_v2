...
VehicleEditModel::VehicleEditModel(QObject* parent) : QAbstractProxyModel {parent} {}

QModelIndex VehicleEditModel::index(int row, int column, const QModelIndex& parent) const
{
...
QModelIndex VehicleEditModel::mapFromSource(const QModelIndex& sourceIndex) const
{
